...
/* função pra definir o destaque da area de texto e o estilo do cursor */
    ...
    /*Obs.: o onChange no textarea vai receber(toda vez que for digitado)
     e passar para o setChangedNote que vai comparar com a informação antiga   */
    return(
        <>
